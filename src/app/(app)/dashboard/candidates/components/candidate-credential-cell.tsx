...
import type { CandidateInviteHistoryItem } from "@/lib/candidates/queries";
...
const inviteToneMap: Record<
  NonNullable<CandidateCredentialCellProps["inviteStatus"]>,
...
function formatInviteHistoryLabel(invite: CandidateInviteHistoryItem) {
    ...
    return (
      <Flex direction="column" gap="1">
        ...
        <Text size="1" color="gray">
          The candidate already signed in through Gitea.
        </Text>
        {inviteCount > 0 ? (
          <Text size="1" color="gray">
